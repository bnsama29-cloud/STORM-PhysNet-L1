...
Unused source files (e.g. `analogy_gates.py`) may exist in `src/` but
...
- Primary control: architecture-matched Transformer (`d_model=128`, 2 layers, 4 heads, FFN still 2048).
