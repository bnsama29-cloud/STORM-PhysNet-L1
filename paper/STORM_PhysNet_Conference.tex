...
ensemble systems over fifteen seeds.
Under synthetic input noise (\(\sigma=1.0\)), the architecture-matched Transformer's 6\,h PE drops to \(0.825\pm 0.010\), while STORM maintains \(0.848\pm 0.008\); we do not treat this robustness probe as a primary table.
...
PE\(_{1\mathrm{h}}\) near \(0.986\mbox{--}0.987\) while the Transformer drops more
